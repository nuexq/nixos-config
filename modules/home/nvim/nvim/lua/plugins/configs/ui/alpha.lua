...
-- Set colors for Alpha using Catppuccin palette
vim.api.nvim_set_hl(0, "AlphaHeader", { fg = catppuccin.lavender })
vim.api.nvim_set_hl(0, "AlphaButton", { fg = catppuccin.mauve })
vim.api.nvim_set_hl(0, "AlphaAttr", { fg = catppuccin.peach })
vim.api.nvim_set_hl(0, "Comment", { fg = catppuccin.overlay1 })
